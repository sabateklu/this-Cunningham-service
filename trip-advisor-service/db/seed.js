...
let randomGenerator = function (min, list) {
...
class Attraction {
  constructor(id) {
    ...
    this.imageUrl = [urlGen(id), urlGen(randomGenerator(0,100)), urlGen(randomGenerator(0,100)), urlGen(randomGenerator(0,100)), urlGen(randomGenerator(0,100))]
...
for (let i = 0; i < 100; i++) {
  let newAttraction = new Attraction(i);
